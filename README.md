...
* `--tests`: Name of the tests file, or a glob pattern to multiple files (for example `tests/*.fga.yaml`). Each file must be in yaml format.  See [Store File Format](docs/STORE_FILE.md) for detailed documentation.
